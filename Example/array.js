const bookArray = [
  ...
  { isbn: '205711499', name: 'Photography', author: 'Vilppu', id_book: 2 },
  {
    isbn: '1892053039',
  ...
  { isbn: '0534613932', name: 'TBA', author: 'Zelanshi', id_book: 4 },
  { isbn: '0534613934', name: 'Shaping Space', author: 'Speight', id_book: 5 },
  { isbn: '0131839780', name: 'Art Since 1940', author: 'Speight', id_book: 6 },
  {
    isbn: '0076417011',
...
console.log('g)');
bookArray.map((x) => console.log(x.name));
